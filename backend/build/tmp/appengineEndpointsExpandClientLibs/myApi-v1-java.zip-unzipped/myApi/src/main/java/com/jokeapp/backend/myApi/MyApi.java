...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://quiet-radius-118713.appspot.com/_ah/api/";
  ...
  public class GetJoke extends MyApiRequest<com.jokeapp.backend.myApi.model.MyBean> {
     ...
     */
    protected GetJoke() {
      super(MyApi.this, "GET", REST_PATH, null, com.jokeapp.backend.myApi.model.MyBean.class);
    }
  ...
  public class SayHi extends MyApiRequest<com.jokeapp.backend.myApi.model.MyBean> {
